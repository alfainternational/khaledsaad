...
return [
    ...
    'conversion_events' => [
        ...
        /*
         * أحداث القمع (§13). مُدرجة هنا لأن `ConversionRecorder` يرفض أي
         * اسم غير معرَّف — والرفض مقصود: حدثٌ باسم مخترع يُكتب صفًّا لا
         * يُحتسب، فيبدو ناجحًا في الكود وصفرًا في اللوحة.
         */
        'flow_started' => 'بدء تدفق',
        'preflight_shown' => 'عرض البوابة',
        'preflight_blocked' => 'اصطدام بحدّ قبل البدء',
        'run_deferred' => 'تأجيل تشغيل لعطل لدينا',
        'task_materialized' => 'توليد مهام من تقرير',
        'task_adopted' => 'تبنّي مهمة',
    ],
];
