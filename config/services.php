...
return [
    ...
    */
    ...
    'private_worker' => [
        ...
        'gateway_max_tokens' => (int) env('AI_PRIVATE_WORKER_GATEWAY_MAX_TOKENS', 128),
        'gateway_model' => env('AI_PRIVATE_WORKER_GATEWAY_MODEL', 'qwen3:1.7b'),
        'reasoning_model' => env('AI_PRIVATE_WORKER_REASONING_MODEL', 'qwen3:4b'),
