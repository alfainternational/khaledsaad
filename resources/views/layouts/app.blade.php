    ...
    <div class="app-shell shell-layout">
        <aside class="app-sidebar shell-sidebar" id="app-sidebar">
            ...
            <nav class="app-nav" aria-label="التنقل الداخلي">
                ...
                <a href="{{ route('interview.show') }}" class="app-nav-link {{ request()->routeIs('interview.*') ? 'active' : '' }}">
                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 3v-3z"/></svg>
                    <span>مقابلة التعريف</span>
                </a>
