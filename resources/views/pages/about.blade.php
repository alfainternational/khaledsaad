...
@php
    ...
    $focusPillars = [
        ...
        [
            ...
            'body' => 'إدارة حملات Google و Meta و LinkedIn بطريقة قائمة على البيانات: تحسين العائد، تقليل الهدر الإعلاني، والتجويد المستمر استناداً إلى تحليلات حقيقية.',
        ],
        [
            'tone' => 'gold',
            'index' => '03',
            'title' => 'الذكاء الاصطناعي التسويقي',
            'body' => 'توظيف نماذج اللغة الكبيرة والأدوات التوليدية لتسريع التحليل، استخراج رؤى من البيانات، وتوليد مخرجات متسقة مع استراتيجية المشروع.',
        ],
    ];
    ...
    $education = [
        [
            ...
            'body' => 'درجة البكالوريوس في تقنية المعلومات مع تركيز على نُظُم المعلومات الإدارية، قواعد البيانات، وتحليل النُظُم وتصميمها. المزج بين الخلفية التقنية وعمل التسويق لاحقاً أنتج طريقة تحليلية قائمة على البيانات في كل قرار تسويقي.',
            'highlights' => [
        ...
        <div class="two-col-wide internal-page-layout">
            <div class="reveal-left">
                ...
                <p class="text-body-lg mb-6">
                    مدير تسويق ومستشار استراتيجي بخبرة تتجاوز {{ $yearsExperience }} عاماً في التسويق الرقمي، من تدريب ميداني في السودان إلى قيادة حملات تسويقية واسعة في المملكة العربية السعودية. مؤسس «منصة خالد سعد» التي تقود رحلة التسويق من الفكرة إلى التنفيذ بخطوات واضحة لا بالعشوائية.
                </p>
...
<section class="section-lg">
    <div class="site-container">
        <div class="section-header reveal">
            <p class="text-eyebrow mb-3 text-p">خطوات العمل</p>
...
<section class="section-lg">
    <div class="site-container">
        <div class="section-header reveal">
            ...
            <p class="text-body max-w-2xl mx-auto">
                الخلفية الأكاديمية في تقنية المعلومات شكّلت الطريقة التي أتعامل بها مع التسويق: صورة مترابطة، وقرارات قائمة على البيانات، وتحليل واضح في كل خطوة.
            </p>
        </div>
        ...
        <div class="two-col-wide about-col-start">
            <div class="reveal-left">
                ...
                <ul class="about-bullet-list">
                    ...
                    <li><strong>إكس (X):</strong> أفكار سريعة، نقاشات، وإشارات إلى أدوات المنصة وطريقة عملها.</li>
                </ul>
            </div>
    ...
    <div class="site-container">
        <div class="cta-section reveal">
            ...
            <div class="cta-section-content">
                ...
                <h2 class="cta-headline">ابدأ رحلة نموّك بخطوات مجرّبة</h2>
