...
@php
    ...
    $featureLabels = [
        ...
        'modules.agency_mode' => 'وضع الوكالة (لإدارة عدة عملاء)',
        'ai_studio.monthly_credits' => 'رصيد توليد ذكي شهري',
    ...
    $faqs = [
        ...
        [
            'q' => 'ماذا يعني «الرصيد» في الاستوديو الذكي؟',
            'a' => 'كل عملية توليد داخل الاستوديو تستهلك جزءاً من رصيدك حسب نوع القالب وحجم المخرج. الباقات تشمل رصيداً شهرياً قابلاً للتجديد.',
        ],
        [
            'q' => 'هل بياناتي معزولة عن مشاريع أخرى؟',
            'a' => 'كل بيئة عمل معزولة بالكامل. لا تتسرب البيانات بين بيئات العمل، حتى لو كانت تحت نفس الحساب.',
        ],
        [
