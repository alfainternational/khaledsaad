...
@php
    $topics = [
        ...
        ['title' => 'الحملات المدفوعة', 'desc' => 'تحليل الأداء، تقليل الهدر، ورفع العائد على الإنفاق.'],
        ['title' => 'الذكاء الاصطناعي التسويقي', 'desc' => 'استخدام أدوات الذكاء الاصطناعي في القرارات والمخرجات.'],
        ['title' => 'بناء الفرق وطريقة العمل', 'desc' => 'قيادة فرق تسويق تعمل بطريقة واضحة.'],
    ];
    ...
    <div class="site-container">
        <div class="section-header reveal max-w-3xl mx-auto">
            ...
            <p class="text-body-lg max-w-2xl mx-auto">
                تحليلات معمّقة، دراسات حالة مصغّرة، وطرق عمل مُختبَرة في التسويق والأداء الرقمي — مكتوبة لتُطبَّق، لا لتُخزَّن.
            </p>
        </div>
