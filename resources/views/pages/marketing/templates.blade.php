...
@php
    $templateBenefits = [
        [
            ...
            'body' => 'كل قالب جرّبناه فعلاً ونجح، وتقدر تعدّله على وضع مشروعك بخطوات واضحة.',
        ],
        [
            'tone' => 'teal',
        ...
        [
            ...
            'body' => 'القوالب تشتغل مع أدوات المنصة والاستوديو الذكي — تنتقل من قالب إلى تنفيذ بضغطة واحدة.',
        ],
    ];
    ...
    <div class="site-container">
        <div class="section-header reveal max-w-3xl mx-auto">
            ...
            <p class="text-body-lg max-w-2xl mx-auto">
                مكتبة منظمة من القوالب التسويقية الجاهزة: خطط، رسائل، نماذج عروض، وسكربتات — كلها مجرّبة ومرتّبة حسب مراحل عملك في المنصة.
            </p>
...
<section class="section-band bg-2">
    <div class="site-container">
        <div class="section-header reveal mb-8">
            ...
            <h2 class="heading-lg mb-4">ثلاثة أسباب <span class="text-gradient">لاستخدام قوالبنا</span></h2>
        </div>
