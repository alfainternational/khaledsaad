...
@section('content')
    ...
    {{--
        لا مساعدة على شاشة الإنشاء عمدًا: المقترح يُبنى على ما نعرفه عن النشاط،
        ولا نشاط بعد. زرٌّ هنا كان سيُنتج كلامًا عامًّا لا يفرّق بين عميل وعميل —
        وهو ما لا يستحق استعلامًا مدفوعًا. تظهر المساعدة في ملف المشروع بعد
        الحفظ، حين يصير للسياق ما يُبنى عليه.

        أما القياس فيجري على هذا المسار كما على غيره: `rememberProfile` يقيس ما
        يُكتب هنا، فلا يفلت مدخلٌ من الحكم لأنه دخل من باب الإنشاء.
    --}}
