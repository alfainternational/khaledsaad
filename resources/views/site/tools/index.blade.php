        ...
        <section class="page-hero">
            <div class="container page-hero__inner">
                ...
                <p class="page-hero__lead">
                    ...
                    ونرجّع لك كلامًا واضحًا تقدر تنفذه — لا تقارير تقرأها وتنساها.
                </p>
        ...
        <section class="section how-section">
            <div class="container">
                <x-section-heading
                    ...
                    description="أربع خطوات فقط، وكل خطوة محفوظة تقدر ترجع إليها في أي وقت."
                />
                <ol class="journey-steps">
                    ...
                    <li><span>04</span><h3>خطة تقدر تنفذها</h3><p>أين المشكلة بالضبط، وما الذي تبدأ به، ومهام لها مواعيد تتابعها.</p></li>
                </ol>
