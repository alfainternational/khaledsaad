...
@section('description', 'تعطّل شيء عندنا أثناء تنفيذ طلبك. أعد المحاولة بعد لحظات.')
    ...
    <main id="main-content">
        <section class="page-hero">
            <div class="container page-hero__inner status-layout">
                ...
                --}}
                <h1>تعطّل شيء عندنا أثناء تنفيذ طلبك.</h1>
                <p class="page-hero__lead">
                    سُجّل الخلل عندنا تلقائيًا وسنعالجه. بياناتك وتقاريرك سليمة،
