...
class TaskGuideDeveloper
{
    ...
    private function fallback(Task $task, ExampleContext $context): array
    {
        ...
        return [
            'how' => 'هذا دليل مبدئي مبني على التوصية نفسها وما نعرفه عن نشاطك، لا على صياغة مخصصة لحالتك. '
                .'ابدأ بالخطوات أدناه، ويمكنك طلب تطوير الدليل مرة أخرى في أي وقت.',
            'when' => $recommendation?->timeframe ?? 'ابدأ هذا الأسبوع، وخصّص لها جلسة واحدة لا تتجاوز الساعة.',
            'where' => 'في المكان الذي يصل منه عملاؤك اليوم؛ إن لم تكن متأكدًا، ابدأ بالقناة التي جاءك منها آخر عميل.',
            'deliverable' => $recommendation?->success_condition
                ?? 'شيء واحد ملموس يمكنك أن تريه لغيرك في نهاية الأسبوع.',
            'steps' => array_values($steps),
            'checkpoints' => ['راجع بعد ثلاثة أيام: هل أنجزت الخطوة الأولى فعلًا أم ما زالت نية؟'],
