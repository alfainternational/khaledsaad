...
final class PlaceholderGuard
{
    ...
    private const PATTERNS = [
        ...
        /*
         * نواب القوالب المعقوفة: `{business_name}` في أجساد قوالب التوصيات.
         *
         * لا يكفي أن يحرسها نائب Laravel أعلاه — صيغتها مختلفة، ومن يربطها
         * `TemplateResolver` لا مترجم Laravel. والعطل هنا أسوأ من عرض رمز خام:
         * النائب الذي تُترجَم حروفه إلى `{اسم_النشاط}` لا يطابق مفتاح الربط،
         * فيبقى ظاهرًا في ورقة العمل التي يسلّمها صاحب النشاط لموظفه.
         */
        'brace' => '/\{[a-z0-9_.-]+\}/i',
