            ...
            $availability[$mode] = match ($mode) {
                ...
                'structured' => [
                    ...
                    'reason' => $canStructured
                        ? null
                        : 'شغّل الأداة مرة بالوضع البسيط أولاً، أو أكمل بيانات مشروعك أكثر لفتح الوضع المرتّب.',
                ],
                'expert' => [
                    'available' => $canExpert,
                    'reason' => $canExpert
                        ? null
                        : 'يحتاج هذا الوضع شغلاً أنضج: شغّل الأداة عدة مرات وأكمل بيانات مشروعك أكثر.',
                ],
