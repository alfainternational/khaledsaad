            ...
            $payload = $this->runner->run(AIRequest::json(
                messages: [
                    ['role' => 'system', 'content' => implode("\n", [
                        ...
                        '3. name: الاسم الأول فقط — بلا اسم عائلة أو قبيلة أو لقب وصفي بعده.',
                        '4. نوّع الشخصيات: المتحمس، المتردد، الحساس للسعر — لا أربع نسخ من شخص واحد.',
                        '5. locations: مدن أو مناطق حقيقية من نطاق عمل المشروع، لا دولًا كاملة. إن كان النطاق مدينة واحدة فأحياؤها أو المدن المجاورة.',
                        '6. interests: اهتمامات قابلة للاستهداف فعلًا في لوحات الإعلان — لا صفات شخصية مثل «طموح».',
                        '7. platforms: المنصات التي تستخدمها هذه الشخصية فعلًا في السوق الخليجي، مرتبة بالأكثر استخدامًا.',
                        '8. gender اختر «الجنسان» إلا إذا كان المنتج نفسه موجَّهًا لجنس بعينه.',
                        '9. motivation دافع واحد يدفعها للشراء، وobjection الجملة التي تقولها لنفسها قبل أن تتجاهل الإعلان — لا تكرّر أوجاعها فيهما.',
                        '10. tone: النبرة التي تصل إليها ومفرداتها ولهجتها المحلية إن كان لها أثر.',
                        '11. quote: جملة تقولها الشخصية عن مشكلتها بلسانها اليومي.',
                    ])],
