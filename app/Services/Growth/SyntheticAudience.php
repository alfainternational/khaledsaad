 ...
 * والخلاصة تعطي نسخة محسّنة من الرسالة.
 */
        ...
        $results = $this->runner->run(AIRequest::json(
            messages: [
                ['role' => 'system', 'content' => implode("\n", [
                    'أنت تدير جلسة مجموعة تركيز افتراضية. ستتقمص كل شخصية من الشخصيات المعطاة وتقيّم رسالة تسويقية.',
                    'القواعد:',
                    ...
                    '5. النسخة المحسّنة تعالج أقوى الاعتراضات دون أن تفقد صوت العلامة.',
                ])],
