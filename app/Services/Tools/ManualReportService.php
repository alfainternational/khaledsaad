...
class ManualReportService
{
    ...
    private function instructions(): string
    {
        return implode(' ', [
            ...
            'اكتب كأنك تكلّمه وجهًا لوجه: عربية بسيطة دافئة بضمير «أنت»، قريبة من كلام الناس، بلا أي مصطلح تقني وبلا ذكر للمنصة أو الأدوات.',
            'اقرأ بيانات المشروع وإجاباته أدناه، ثم أعد كائن JSON واحدًا فقط يطابق required_output_schema حرفيًا، دون أي نص خارج الكائن.',
            ...
            'صارحه: ميّز بوضوح بين ما يدعمه كلامه (is_assumption=false) وما هو اجتهاد منك (is_assumption=true).',
