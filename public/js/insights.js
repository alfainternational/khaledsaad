...
if (visit && view && endpoint) {
    ...
    /*
     * نبضة أولى فور التحميل، قبل أي انتظار.
     *
     * وصولها هو ما يُثبت للخادم أن متصفّحًا حقيقيًّا فتح هذه الصفحة —
     * وهو الأساس الذي تُبنى عليه كل أرقام اللوحة. تأخيرها خمس عشرة
     * ثانية كان يترك «من على الموقع الآن» فارغًا أمام زائر موجود فعلًا،
     * ويُسقط من غادر قبل أول نبضة من العدّ كأنه لم يأتِ.
     *
     * وهي بصفر ثانية بلا ضرر: الخادم يُسنِد الأكبر ولا يجمع.
     */
    send('heartbeat');
