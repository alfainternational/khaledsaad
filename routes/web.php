...
Route::middleware('auth')->prefix('api')->group(function (): void {
    ...
    Route::post('/ai/conversations/{conversationPublicId}/messages', [AiConversationController::class, 'storeMessage'])->middleware('throttle:ai-assist')->name('api.ai.conversations.messages.store');
    Route::get('/ai/conversations/{conversationPublicId}/messages/{messagePublicId}', [AiConversationController::class, 'showMessage'])->name('api.ai.conversations.messages.show');
